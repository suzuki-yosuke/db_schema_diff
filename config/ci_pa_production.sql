...
+++ `prod_pa_production`
@@ -1 +1 @@
-CREATE DATABASE `ci_pa_production` /*!40100 DEFAULT CHARACTER SET utf8mb4 */
+CREATE DATABASE `prod_pa_production` /*!40100 DEFAULT CHARACTER SET utf8mb4 */
...
# Comparing `ci_pa_production`.`oauth_applicationable_oauth_applications` to `prod_pa_production`.`oauth_applicationable_oauth_applications`   [PASS]
...
# Comparing `ci_pa_production`.`schema_migrations` to `prod_pa_production`.`schema_migrations`   [PASS]
